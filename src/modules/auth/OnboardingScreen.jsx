...
function UsersPanel(){
  ...
  async function createUser(){
    ...
    // 1. Crear usuario con signUp (funciona con anon key)
    ...
    if(profErr){setCreateError('Usuario creado pero error al configurar perfil: '+profErr.message);setCreating(false);return}
